...
/**
 * Akidiva UI - Table Suite
 * High-density data display for patient records and hospital management.
 */
...
const TableRow = React.forwardRef(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors hover:bg-blue-50/30 data-[state=selected]:bg-blue-50",
      className
    )}
    {...props}
  />
...
const TableHead = React.forwardRef(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle font-bold text-gray-400 uppercase tracking-widest text-[10px] whitespace-nowrap",
      className
    )}
    {...props}
  />
